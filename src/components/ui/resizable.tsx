...
/** Invisible resize seam — drag still works; no grip chrome. */
const ResizableHandle = ({
  ...
  <ResizablePrimitive.PanelResizeHandle
    className={cn(
      "group relative flex w-px items-center justify-center bg-border/60",
      "after:absolute after:inset-y-0 after:left-1/2 after:w-2 after:-translate-x-1/2",
      "hover:bg-foreground/25 active:bg-foreground/35",
